...
class Consumer(object):
    ...
    """
    # EXCHANGE = 'exchange.aiya'
    # EXCHANGE_TYPE = ExchangeType.direct
    # QUEUE = 'queue.aiya'
    # ROUTING_KEY = 'routing.aiya'

    def __init__(self, host, port, virtual_host, username, password, queue_name):
...
class ReconnectingExampleConsumer(object):
    ...
    def __init__(self, host, port, virtual_host, username, password, queue_name):
        ...
        self._password = password
        self._queue_name = queue_name
        self._consumer = Consumer(self._host, self._port, self._virtual_host, self._username, self._password, self._queue_name)
    ...
    def _maybe_reconnect(self):
        if self._consumer.should_reconnect:
            ...
            self._consumer = Consumer(self._host, self._port, self._virtual_host, self._username, self._password,
                                      self._queue_name)
...
def main():
    ...
    consumer = ReconnectingExampleConsumer(host=host, port=port, virtual_host=virtual_host, username=username, password=password, queue_name=queue_name)
    consumer.run()
